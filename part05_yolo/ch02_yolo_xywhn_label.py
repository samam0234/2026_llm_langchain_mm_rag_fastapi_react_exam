...
def red_boxes_to_yolo_labels(image_path, class_id=0, red_lower=(0, 0, 150), red_upper=(80, 80, 255)):
    ...
    for cnt in contours: 
        ...
        bx, by, bw, bh = cv2.boundingRect(cnt)  # 윤곽선을 감싸는 최소 크기의 사각형 좌표 (x, y, w, h)
...
image_path="annotated/ijh_04.jpg"
...
cv2.imwrite("debug_004.jpg", debug)

# .txt 라벨 파일 저장
txt_path = save_yolo_label(labels, image_path=image_path, label_dir="labels/train")
