...
# OpenAIEmbeddingFunction : chromadb가 문서 저장/검색시 자동으로
...
# Collection : Vector DB안의 데이터를 정상하는 단위 (RDB 에서의 테이블 개념과 유사)
...
# ChromaDB 에 저장 (RDB에서의 insert into문)
# text를 자동으로 백터로 변환후 저장한다.
collection.add(
